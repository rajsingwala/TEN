...
const BlogPageTitle = ({ data, input, setInput }) => {
  ...
  return (
    <div className="blog_page_title">
      <div
        className="blog_page_title_left"
        onClick={() => history.push("/blog")}
      >
        All Posts
      </div>
      <div className="blog_page_title_right">
        {search ? (
          <div className="blog_page_title_right_input">
            <div className="blog_page_title_right_input_search">
            ...
            <div className="blog_page_title_right_input_close">
