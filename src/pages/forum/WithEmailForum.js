...
const WithEmailForum = ({
  ...
  return (
    <div className="with_email popup">
      {/* email */}
      <div className="with_email_input popup">
        <label>Email</label>
        <input type="text" />
      </div>
      ...
      {emailLogin && (
        <p
          className="with_email_forgot popup"
          onClick={() => {
            handleForgot();
            setEmailLogin(false);
            setSignup(false);
      ...
      {/* button */}
      <div className="with_email_btn">{emailLogin ? "Sign In" : "Sign Up"}</div>

      {/* or */}
      <div className="with_email_or popup">{`or sign ${
        emailLogin ? "in" : "up"
      } with`}</div>

      {/* google-fb-icon */}
      <div className="with_email_icon popup">
        {" "}
        {/* fb */}
        <div>
          <svg
